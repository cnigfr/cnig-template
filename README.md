...
## Contexte
_Le contexte dans lequel le schéma a été élaboré. Il peut être utile de renvoyer ici vers la page du GT CNIG où la documentation du standard correspondant peut être trouvée._
...
* _A supprimer en l'absence de schéma JSON_ Le dossier [schéma](schéma) contient le schéma ainsi que les documents qui lui sont liés.
